...
{
    /// <summary>
    /// Player action of short pass.
    /// </summary>
    public class ShortPassPlayerAction : IPlayerAction
    {
        private const PlayerReaction PlayerReaction = Actions.PlayerReaction.Interception;
        private const int ShortPassScore = 1;
        ...
        {
            advanceScoreManager.IncrementAdvanceScore(ShortPassScore);
        }
    }
}